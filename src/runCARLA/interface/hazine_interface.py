...
class SensorCollector():
    ...
    def read(self, wait_period=0.05, timeout = 50):
        empty = True
...
class World(object):
    ...
    def restart(self):
        ...
        # Camera configuration must be same with train dataset images atributes
        camera = {
            "id": "rgb",
...
class CameraManager(object):
    ...
    def render(self, display):
        ...
        if self._agent_view is not None:
            ...
            display.blit(self._agent_view, (0, 0))
...
def game_loop(args, agent):
    ...
    try:
        ...
        # Set spawn points
        # Use the first one or choose randomly
        spawn_point = world.world.get_map().get_spawn_points()[random.randint(0, 40)]
        #spawn_point = world.world.get_map().get_spawn_points()[1]
        ...
        while True:
            ...
            # Find the next control values
            control = agent.run_step(world, sensor_data, (spawn_point.location.x,
            ...
            # Apply the sended throtle, break and steering angles values
            world.vehicle.apply_control(control)

            world.vehicle.get_control()
